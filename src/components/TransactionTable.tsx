  ...
  return (
    <>
      <ReactPaginate
        ...
        pageLinkClassName='text-white text-xs px-2 rounded-sm'
        previousClassName='text-white py-1 px-2 bg-slate-800 rounded-sm text-sx'
        nextClassName='text-white py-1 px-2 bg-slate-800 rounded-sm text-sx'
